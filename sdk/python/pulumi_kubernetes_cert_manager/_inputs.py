...
class CertManagerCrdsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Enable customization of the installation of CRDs. Cannot be enabled with installCRDs.
        :param pulumi.Input[builtins.bool] keep: Keep CRDs on chart uninstall. Setting to false will remove CRDs when the chart is removed.
        """
