...
func NewCertManager(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("chart-cert-manager:index:CertManager", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (*CertManager) ElementType() reflect.Type {
	return reflect.TypeOf((*CertManager)(nil))
}
...
func (i *CertManager) ToCertManagerPtrOutput() CertManagerPtrOutput {
	return i.ToCertManagerPtrOutputWithContext(context.Background())
}

func (i *CertManager) ToCertManagerPtrOutputWithContext(ctx context.Context) CertManagerPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CertManagerPtrOutput)
}

type CertManagerPtrInput interface {
	pulumi.Input

	ToCertManagerPtrOutput() CertManagerPtrOutput
	ToCertManagerPtrOutputWithContext(ctx context.Context) CertManagerPtrOutput
}

type certManagerPtrType CertManagerArgs

func (*certManagerPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**CertManager)(nil))
}

func (i *certManagerPtrType) ToCertManagerPtrOutput() CertManagerPtrOutput {
	return i.ToCertManagerPtrOutputWithContext(context.Background())
}

func (i *certManagerPtrType) ToCertManagerPtrOutputWithContext(ctx context.Context) CertManagerPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(CertManagerPtrOutput)
}
...
func (o CertManagerOutput) ToCertManagerPtrOutput() CertManagerPtrOutput {
	return o.ToCertManagerPtrOutputWithContext(context.Background())
}

func (o CertManagerOutput) ToCertManagerPtrOutputWithContext(ctx context.Context) CertManagerPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v CertManager) *CertManager {
		return &v
	}).(CertManagerPtrOutput)
}

type CertManagerPtrOutput struct{ *pulumi.OutputState }

func (CertManagerPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**CertManager)(nil))
}

func (o CertManagerPtrOutput) ToCertManagerPtrOutput() CertManagerPtrOutput {
	return o
}

func (o CertManagerPtrOutput) ToCertManagerPtrOutputWithContext(ctx context.Context) CertManagerPtrOutput {
	return o
}

func (o CertManagerPtrOutput) Elem() CertManagerOutput {
	return o.ApplyT(func(v *CertManager) CertManager {
		if v != nil {
			return *v
		}
		var ret CertManager
...
func (CertManagerMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]CertManager)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(CertManagerPtrOutput{})
