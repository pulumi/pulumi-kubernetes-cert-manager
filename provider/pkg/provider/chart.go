...
type CertManagerArgs struct {
	...
	Strategy     *appsv1.DeploymentStrategy `pulumi:"strategy" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:apps/v1:DeploymentStrategy"`
	...
	ExtraEnv  *[]corev1.EnvVar             `pulumi:"extraEnv" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:core/v1:EnvVar"`
	...
	SecurityContext *corev1.PodSecurityContext `pulumi:"securityContext" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:core/v1:PodSecurityContext"`
	// Container Security Context to be set on the controller component container.
	// ref: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/
	ContainerSecurityContext *corev1.SecurityContext `pulumi:"containerSecurityContext" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:core/v1:SecurityContext"`
	Volumes                  *[]corev1.Volume        `pulumi:"extraVolumes" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:core/v1:Volume"`
	VolumeMounts             *[]corev1.VolumeMount   `pulumi:"extraVolumeMounts" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:core/v1:VolumeMount"`
	...
	PodDnsConfig    *corev1.PodDNSConfig        `pulumi:"podDnsConfig" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:core/v1:PodDNSConfig"`
	NodeSelector    *corev1.NodeSelector        `pulumi:"nodeSelector" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:core/v1:NodeSelector"`
...
type CertManagerCaInjector struct {
	...
	// ref: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/
	SecurityContext *corev1.PodSecurityContext `pulumi:"podSecurityContext" pschema:"ref=/kubernetes/v3.8.1/schema.json#/types/kubernetes:core/v1:PodSecurityContext"`
